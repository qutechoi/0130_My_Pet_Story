...
function FrameCard({ frame, frameImage, lang }) {
    ...
    <div className="rounded-2xl bg-white/5 border border-white/10 overflow-hidden">
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="space-y-2 text-sm">
          <div>
            <span className="text-[#ee9d2b] font-semibold text-xs uppercase tracking-wider">{t(lang, 'visual')}</span>
            <p className="text-slate-400 mt-0.5 leading-relaxed">{visualDescription}</p>
          </div>
          <div>
            <span className="text-[#ee9d2b] font-semibold text-xs uppercase tracking-wider">{t(lang, 'action')}</span>
            <p className="text-slate-400 mt-0.5 leading-relaxed">{action}</p>
          </div>
          {dialogue && (
            <div>
              <span className="text-[#ee9d2b] font-semibold text-xs uppercase tracking-wider">{t(lang, 'mood')}</span>
              <p className="text-slate-300 mt-0.5 leading-relaxed italic">{dialogue}</p>
            </div>
          )}
          {transition && (
            <div>
              <span className="text-[#ee9d2b] font-semibold text-xs uppercase tracking-wider">{t(lang, 'transition')}</span>
